...
CGL::EventHandler::EventHandler(sf::RenderWindow& window) : m_window(&window) {
...
CGL::EventHandler::~EventHandler() = default;

void CGL::EventHandler::resetKeyStatus() {
...
void CGL::EventHandler::updateEvents() {
    sf::Event event{};
...
const CGL::EventHandler::WindowStatus &CGL::EventHandler::getWindowStatus() const {
    return this->m_windowStatus;
}

const CGL::EventHandler::KeyStatus &CGL::EventHandler::getKeyStatus(const sf::Keyboard::Key &key) const {
