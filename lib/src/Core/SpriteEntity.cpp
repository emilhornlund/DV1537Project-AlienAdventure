...
CGL::SpriteEntity::SpriteEntity() : IEntity() {}

CGL::SpriteEntity::~SpriteEntity() = default;

void CGL::SpriteEntity::setTextureRect(const sf::IntRect &rect) {
...
const sf::IntRect& CGL::SpriteEntity::getTextureRect() const {
    return this->m_textureRect;
}

void CGL::SpriteEntity::setColor(const sf::Color &color) {
...
void CGL::SpriteEntity::draw(sf::RenderTarget &target, sf::RenderStates states) const {
