...
EnemyBee::EnemyBee(const EnemyBee &original) = default;

EnemyBee::~EnemyBee() = default;

EnemyBee &EnemyBee::operator=(const EnemyBee &original) = default;

EnemyBee *EnemyBee::clone() const {
    return new EnemyBee(*this);
}
